...
default[:ruby19][:package_url] = "http://www.mirrorservice.org/sites/ftp.ruby-lang.org/pub/ruby/#{node[:ruby19][:version_major][0,3]}/#{node[:ruby19][:package_name]}"
default[:ruby19][:target_dir] = "/opt/ruby-#{node[:ruby19][:version]}"
default[:ruby19][:link_dir] = "/opt/ruby"
set[:ruby19][:bin_dir] = "#{node[:ruby19][:link_dir]}/bin"
default[:ruby19][:gem_dir] = "#{node[:ruby19][:link_dir]}/lib/ruby/gems/#{node[:ruby19][:gems_version]}/gems"
